...
$conex = conectar();
    ...
    if(isset($_POST['id_codqfdcliente'])){
        ...
        echo "<select class='form-control show-tick' name='codClienteBenchC' id='codClienteBenchC'>";
        ...
        echo "<select class='form-control show-tick' name='codClienteBenchC' id='codClienteBenchCM'>";
        echo "<option value='0'>Seleccione un Cliente</option>";
