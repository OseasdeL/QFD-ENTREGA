...
<html>
    <head>
        ...
        <title>Sistema QFD | Formulario Competencias</title>
        <!-- Favicon-->
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <form action="../../php/Mantenimientos/ABC_Competencia.php" method="POST">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control show-tick" name="codCliente">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="nCompetencia" required>
                                            <label class="form-label">Nombre Competencia</label>
                                        </div>
                                    </div>                                                  
                                    <button class="btn btn-primary waves-effect" type="submit" name="inComp">INGRESAR</button>
                                </form>                        
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form action="../../php/Mantenimientos/ABC_Competencia.php" method="POST">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="cCompetencia" required>
                                    ...
                                    <button class="btn btn-primary waves-effect" type="submit" name="upComp">MODIFICAR</button>
                                </form>                        
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form action="../../php/Mantenimientos/ABC_Competencia.php" method="POST">
                                    ...
                                    <button class="btn btn-primary waves-effect" type="submit" name="delComp">ELIMINAR</button>
                                </form>                        
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        <tbody>
                                            <?php   
                                                $query = "SELECT ID_COMPETENCIA, NOMBRE, ID_C, NOM_C FROM COMPETENCIA";
                                                ...
                                                while($fila2 = mysqli_fetch_array($rs)){
                                                    ...
                                                    echo "<tr>";
                                                        echo "<td> $fila2[ID_COMPETENCIA] </td>";
