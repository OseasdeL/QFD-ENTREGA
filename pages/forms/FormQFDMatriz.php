...
<html>
    <head>
        ...
        <title>Sistema QFD | Formulario Matriz de Relación</title>
        <!-- Favicon-->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
				$("#codigoQFD").change(function () {
					...
					$("#codigoQFD option:selected").each(function () {
						...
						$.post("../../php/QFD_QfdQue.php", { id_codqfdque: id_codqfdque }, function(data){
							$("#codigoQue").html(data);
						});            
					});
				})
            ...
            $(document).ready(function(){
				$("#codigoQFD").change(function () {
					...
					$("#codigoQFD option:selected").each(function () {
						id_codqfdcomo = $(this).val();
						$.post("../../php/QFD_QfdComo.php", { id_codqfdcomo: id_codqfdcomo }, function(data){
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form action="../../php/Mantenimientos/ABC_Matriz.php" method="POST">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line" id="codigoQue">
                                            <select class="form-control show-tick" name="codigoQue" id="codigoQue"> 
                                    ...
                                    <button name="inMat" class="btn btn-primary waves-effect" type="submit">INGRESAR</button>
                                </form>                           
                            </div>
                        </div>
                    </div>
