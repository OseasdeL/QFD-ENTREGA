...
<html>
    <head>
        ...
        <title>Sistema QFD | Formulario Registro Que's</title>
        <!-- Favicon-->
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">                
                    ...
                    <a class="navbar-brand" href="../../Menu.php">NECESIDADES</a>
                </div>            
            </div>
        </nav>
        <!-- #Top Bar -->
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <form action="../../php/Mantenimientos/ABC_Necesidades.php" method="POST">                                
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="nombreN" required>
                                            <label class="form-label">Nombre Requerimiento</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control show-tick" name="codPS">
                                                <option>Producto/Servicio</option>
                                                    <?php
                                                        $select = "SELECT id_ps, nom_ps FROM prod_serv";
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea name="desN" cols="30" rows="5" class="form-control no-resize" required></textarea>
                                            <label class="form-label">Descripción del requerimiento</label>
                                        </div>
                                    </div>                                                                
                                    <button class="btn btn-primary waves-effect" type="submit" name="inN">INGRESAR</button>
                                </form>                    
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form action="../../php/Mantenimientos/ABC_Necesidades.php" method="POST">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="codigoN" required>
                                            <label class="form-label">Código Requerimiento</label>
                                        </div>
                                    </div>                                
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                    ...
                                    <button class="btn btn-primary waves-effect" type="submit" name="upN">MODIFICAR</button>                                    
                                </form>                    
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form action="../../php/Mantenimientos/ABC_Necesidades.php" method="POST">
                                    ...
                                    <button class="btn btn-primary waves-effect" type="submit" name="delN">ELIMINAR</button>
                                </form>                    
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        <tbody>
                                            <?php  
                                                $query = "SELECT ID_QUE, NOM_QUE, PRIORIDAD, ID_PS, NOM_PS, DESC_QUE FROM QUES";
