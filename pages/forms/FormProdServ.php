...
<html>
    <head>
        ...
        <title>Sistema QFD | Formulario Productos/Servicios</title>
        <!-- Favicon-->
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">                
                    ...
                    <a class="navbar-brand" href="../../Menu.php">PRODUCTOS/SERVICIOS</a>
                </div>            
            </div>
        </nav>
        <!-- #Top Bar -->
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>
                                    INGRESO PRODUCTOS Y/O SERVICIOS
                                </h2>                            
                            </div>
                            <div class="body">
                                <form action="../../php/Mantenimientos/ABC_ProdServ.php" method="POST">                                
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="nombreP" required>
                                            <label class="form-label">Nombre Producto/Servicio</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control show-tick" name="clienteP">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="precioP" required>
                                            <label class="form-label">Precio Producto/Servicio</label>
                                        </div>
                                    </div> 
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea name="desP" cols="30" rows="5" class="form-control no-resize" required></textarea>
                                            <label class="form-label">Descripción del producto/servicio</label>
                                        </div>
                                    </div>                                                                
                                    <button class="btn btn-primary waves-effect" type="submit" name="inPS">INGRESAR</button>
                                </form>                                                    
                                <!-- ----- -->
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form action="../../php/Mantenimientos/ABC_ProdServ.php" method="POST">                                
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="codigoPS" required>
                                            <label class="form-label">Código Producto/Servicio</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                    ...
                                    <button class="btn btn-primary waves-effect" type="submit" name="upPS">MODIFICAR</button>                                    
                                </form>                                                    
                                <!-- ----- -->
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form action="../../php/Mantenimientos/ABC_ProdServ.php" method="POST">                                
                                    ...
                                    <button class="btn btn-primary waves-effect" type="submit" name="delPS">ELIMINAR</button>
                                </form>                                                    
                                <!-- ----- -->
                            </div>
                        </div>
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        <tbody>
                                            <?php 
                                                $query = "SELECT ID_PS, NOM_PS, PRECIO, DES_PS, ID_C, NOM_EMP FROM prod_serv";
